...
/**
 * Componente que maneja la información del deliveri.
 */
...
Deliv.propTypes = {
  /** Query */
  GET_ORDERS: PropTypes.arrayOf(PropTypes.object).isRequired,
  /** Mutation */
  ACCEPT_ORDER: PropTypes.arrayOf(PropTypes.object).isRequired,
  /** Mutation */
